...
Delay:
	...
	MOV R3, #250
	LOOP11: MOV R4, #255 
	LOOP12: DJNZ R4, LOOP12
		   DJNZ R3, LOOP11
		   
	MOV R3, #250
	LOOP13: MOV R4, #255 
	LOOP14: DJNZ R4, LOOP14
		   DJNZ R3, LOOP13
	
	MOV R3, #250
	LOOP15: MOV R4, #255 
	LOOP16: DJNZ R4, LOOP16
		   DJNZ R3, LOOP15
		   
	MOV R3, #250
	LOOP17: MOV R4, #255 
	LOOP18: DJNZ R4, LOOP18
		   DJNZ R3, LOOP17
...
myprogram:
    ...
    lcall WriteCommand
 	mov a, #0x0E ; Move cursor to line 1 column 1
    lcall WriteCommand
    mov a, #'i'
    lcall WriteData
    mov a, #' '
    ...
    mov a, #0xC0 ; Move cursor to line 2 column 0
    lcall WriteCommand
